    ...
    style={{
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-3/4">
          ...
          <p className="text-lg">
            We are actively seeking partnerships with organizations all over
            the world in order to grow the mentoring movement.
          </p>
        </div>

        {/* Right Button */}
        <div className="mt-8 md:mt-0 md:w-1/4 flex justify-end">
          <button className="bg-white text-[#FF6B6B] font-semibold py-3 px-6 rounded-full shadow-lg hover:bg-gray-200 transition">
            Let’s Get Started
          </button>
        </div>
      </div>
